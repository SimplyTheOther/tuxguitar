...
public class TGBeatSpacing extends TGSpacing {
	...
	public static final int POSITION_PALM_MUTE_EFFEC = 7;
	public static final int POSITION_LET_RING_EFFEC = 8;
	public static final int POSITION_VIBRATO_EFFEC = 9;
	public static final int POSITION_TRILL_EFFEC = 10;
	public static final int POSITION_FADE_IN = 11;
